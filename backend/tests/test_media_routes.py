...
The PNG and PDF are built in code (conftest.sample_png / sample_pdf) rather
than committed. A checked-in binary is an opaque blob nobody can review in a
diff; a generated one is a few readable lines, and the PDF builder in
...
from backend.tests.conftest import blank_png as _blank_png
from backend.tests.conftest import sample_pdf as _pdf
from backend.tests.conftest import sample_png as _png
